...
public class ConnectionUtil {
	...
	// parallel processing and threads - the keyword synchronized means that only
	// one thread
	...
	public Connection getConnection() {
		...
		// get our credentials from the connectionUtils properties object that we
