...
// CLASS
public class AdminUpdateDescriptionRunner {

	// SELENIUM WEB DRIVER
	public static WebDriver driver;

	// CONNECTION TO AdminUpdateDescriptionPage
	public static AdminUpdateDescriptionPage adminUpdateDescriptionPage;
	...
	public static void setup() {
		...
		adminUpdateDescriptionPage = new AdminUpdateDescriptionPage(driver);
	}
